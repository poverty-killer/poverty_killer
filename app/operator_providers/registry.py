...
PROVIDER_PROFILES: tuple[ProviderProfile, ...] = (
    ...
    ProviderProfile(
        ...
        purpose="Advisory adapter capability only; Stage 4 catalog-wide cross-venue ingestion is not wired.",
        implemented=True,
        enabled_by_default=True,
        read_only_validation_supported=False,
        setup_instructions="No credentials required. Adapter readiness is not an active runtime contribution and cannot satisfy Alpaca executable truth.",
    ),
    ProviderProfile(
