    ...
    "risk_gates": AuthorityEntry(
        ...
        contributors=(
            ...
            _contributor(
                ...
                "Staleness and source-health hazard evidence consumed by pre-trade guardrails.",
                "May veto stale temporal observations under the pre-trade owner; cannot own final admission or broker mutation.",
                conflict_ids=(2,),
            ),
            _contributor(
                "risk_gates",
                ...
                "gate_input",
                "Stateful sovereign capital authorization model represented as intentionally dormant evidence.",
                "Dormant until Phase H/I arming; cannot create a second admission, sizing, or broker mutation path.",
                status="BLOCKED",
                blocked_reason="DORMANT_BY_POLICY_PENDING_PHASE_HI_ARM",
                conflict_ids=(2,),
            ),
        ),
    ),
