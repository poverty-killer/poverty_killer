...
DEFAULT_WATCHLIST = ("BTC/USD", "ETH/USD", "SOL/USD", "LTC/USD", "AVAX/USD", "LINK/USD")
DEFAULT_ALLOWED_DURATIONS = frozenset(
    {180, 300, 900, 1200, 1800, 3600, 7200, 10800, 14400, 86400, 259200, 432000}
)
