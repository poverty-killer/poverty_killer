...
class OpenInsiderAdapter:
    """
    Starter OpenInsider adapter scaffold.

    This adapter remains subordinate and non-authoritative by default.
    """

    source_family: SourceFamily = SourceFamily.OPENINSIDER
    ...
    def normalize_payload(self, payload: dict[str, Any]) -> WorldAwarenessEvent:
        return normalize_source_payload(
            ...
            source_event_type=str(payload.get("source_event_type", "openinsider_activity")),
            raw_payload=payload,
