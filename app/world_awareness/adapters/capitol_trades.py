...
class CapitolTradesAdapter:
    """
    Starter Capitol Trades adapter scaffold.

    This adapter remains subordinate, disclosure-delayed, and non-live-attached.
    """

    source_family: SourceFamily = SourceFamily.CAPITOL_TRADES
    ...
    def normalize_payload(self, payload: dict[str, Any]) -> WorldAwarenessEvent:
        return normalize_source_payload(
            ...
            source_event_type=str(payload.get("source_event_type", "political_trade_disclosure")),
            raw_payload=payload,
