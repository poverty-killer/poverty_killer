...
@dataclass
class QuiverFreeAdapter:
    """
    Starter Quiver free-surface adapter scaffold.

    This adapter remains subordinate and non-authoritative by default.
    """

    source_family: SourceFamily = SourceFamily.QUIVER_FREE
    ...
    def normalize_payload(self, payload: dict[str, Any]) -> WorldAwarenessEvent:
        return normalize_source_payload(
            ...
            source_event_type=str(payload.get("source_event_type", "alternative_public_signal")),
            raw_payload=payload,
