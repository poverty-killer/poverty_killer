      ...
      runs: [
        {
          ...
          ordersCanceled: 0,
          orderPostAttempted: 0,
          orderPostAcknowledged: 0,
          cancelAttempted: 0,
          cancelAcknowledged: 0,
          runtimeFills: 0,
          brokerFilledOrders: 0,
          localFills: 0,
          baselinePositionsCount: "mock-only",
          postCount: 0,
          deleteCount: 0,
          openOrdersAtShutdown: "mock-only",
          fillsObserved: 0,
          tcaStatus: "STATIC_MOCK_ONLY",
          feeTcaStatus: "STATIC_MOCK_ONLY",
          readiness72h: "NOT_APPROVED_MOCK_DATA",
          reasonCodes: ["STATIC_MOCK_DATA_NOT_RUNTIME_EVIDENCE", "BACKEND_REQUIRED_FOR_RUN_TRUTH"],
          reportPath: "not generated in mock mode"
        }
      ]
    },
    explanation: {
      headline: "Static mock-only DecisionFrame sample. Backend runtime evidence is required before any trade, edge, TCA, or performance conclusion.",
      frameId: "mock-only-static-sample",
      output: "MOCK_ONLY",
      netEdge: "NOT_RUNTIME_EVIDENCE",
      confidence: "LOW",
      nextBestAction: "Connect to the operator backend and inspect real archive/report evidence.",
      blockers: [],
      missingTruth: ["BACKEND_RUNTIME_EVIDENCE_REQUIRED"]
    },
    actionCenter: {
      counts: {
        INFO: 2,
